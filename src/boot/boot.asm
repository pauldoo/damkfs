...
OEMIdentifier      db 'DAMKFS  '
BytesPerSector     dw 0x200
SectorsPerCluster  db 0x10 ; 8 KiB clusters
...
SectorsBig         dd 0x000F4240 ; 1M sectors, 62.5K 8KiB clusters
...
load32:
  ...
  ; number of sectors to read (see test in Makefile)
  ; also must be less than FAT16 reserved sectors above.
  mov ecx, 100
